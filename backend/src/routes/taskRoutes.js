...
const { requireAuth, blockIfOnHold } = require('../middleware/authMiddleware');
...
router.post('/:id/submit', requireAuth, blockIfOnHold, uploadProof.single('proofFile'), taskController.submitTask);
